...
import 'package:management249/models/resource_model.dart';
import 'package:management249/models/user_model.dart';
import 'package:management249/utils/constants.dart';
...
class ApiService {
  ...
  Future<String> login(String email, String password) async {
    //TODO: chech that the person logging in is indeed an admin.
  ...
  Future<List<ResourceBookingModel>> getAllBookings() async {
    String endpoint = "booking/allBookingsAdmin/";
